...
def test_get_connection_properties__by_key(
    dbutils, scope: str = 'ACC', db_key: str = 'DWH_BI1'
):
    username = dbutils.secrets.get(scope=scope.upper(), key=f'{db_key}__JDBC_USERNAME')
