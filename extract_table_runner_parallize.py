...
config_name_base = os.path.splitext(jp_work_config_filename)[0]
...
if not os.path.exists(notebook_path_full):
    raise Exception(f"File does not exis. Copy generated file AS NOTEBOOK into {notebook_path_full}")
