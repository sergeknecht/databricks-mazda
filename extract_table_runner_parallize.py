...
work_items = [
    {
        ...
        'catalog_name': f"{jp_scope.lower()}__{work_json.get('catalog', jp_catalog_name_default)}" if not extract_pii else f"{jp_scope.lower()}__{work_json.get('catalog', jp_catalog_name_default)}_pii",
